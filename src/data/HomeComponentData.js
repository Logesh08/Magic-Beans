...
export const mySeedsStat = [{ title: 'Connect Wallet' }];
export const myAllStat = [
  { title: 'EST:', text: 'Connect Wallet' }, //100 Seeds/Day
  { title: 'Pending Rewards:', text: 'Connect Wallet' }, //100
];
export const myBeansStat = [{ title: '2' }];
export const priceStat = [{ title: 'For 10 000 SEEDS' }];
export const TVLStat = [{ title: 'Connect Wallet' }, { title: '$10 000' }]; //650 000 000 SEEDS
export const totalBeansStat = [{ title: 'Connect Wallet' }]; //50 000
